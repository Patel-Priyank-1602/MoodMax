    ...
    <>
      <nav className="navbar" id="main-navbar">
        <div className="navbar-inner">
          ...
          {/* Center Pill Capsule (Analyzer & Batch) - Desktop only */}
          <div className="navbar-pill-group desktop-only" role="tablist">
            <NavLink
              to="/"
              end
              className={({ isActive }) =>
          ...
          {/* Right Section: Desktop Links & Mobile Hamburger Toggle */}
          <div className="navbar-right-actions">
            ...
            <button
              type="button"
              className="navbar-toggle-btn mobile-only"
              onClick={() => setIsDrawerOpen(!isDrawerOpen)}
              aria-label={isDrawerOpen ? 'Close menu' : 'Open navigation menu'}
              aria-expanded={isDrawerOpen}
              id="mobile-nav-toggle"
            >
              <span className={`hamburger-bar ${isDrawerOpen ? 'hamburger-bar-active' : ''}`}></span>
              <span className={`hamburger-bar ${isDrawerOpen ? 'hamburger-bar-active' : ''}`}></span>
              <span className={`hamburger-bar ${isDrawerOpen ? 'hamburger-bar-active' : ''}`}></span>
            </button>
          </div>
      ...
      {/* Mobile Side Drawer matching QueryIQ design */}
      <aside
        className={`side-drawer ${isDrawerOpen ? 'side-drawer-open' : ''}`}
      ...
      >
        <div className="drawer-content">
          ...
          <div className="drawer-section">
            ...
            <div className="drawer-nav-list">
              ...
              >
                ...
                <span className="drawer-item-text">Analyzer</span>
              </NavLink>
              ...
              >
                ...
                <span className="drawer-item-text">Batch</span>
              </NavLink>
            </div>
          </div>
          ...
          {/* Section: CONNECT */}
          <div className="drawer-section">
            <span className="drawer-section-title">CONNECT</span>
            <div className="drawer-connect-grid">
              <a
                href="mailto:patelpriyank2526@gmail.com"
                className="drawer-connect-btn"
                title="Send Email"
                aria-label="Email"
              >
